...
# The Barts Group
create_site(get_acute_site('East London NHS Foundation Trust', 'NEL Trusts'))
create_site(get_acute_site('Homerton', 'NEL Trusts'))
create_site(get_acute_site('Mile End Hospital', 'NEL Trusts'))
create_site(get_acute_site('NEL Emergency Store', 'NEL Trusts'))
create_site(get_acute_site('NELFT', 'NEL Trusts'))
create_site(get_acute_site('Newham Hospital', 'NEL Trusts'))
create_site(get_acute_site('Nightingale Hospital', 'NEL Trusts'))
create_site(get_acute_site('Queens', 'NEL Trusts'))
create_site(get_acute_site('Queens and King George', 'NEL Trusts'))
create_site(get_acute_site('Royal London Hospital', 'NEL Trusts'))
create_site(get_acute_site('St Bartholomew', 'NEL Trusts'))
create_site(get_acute_site('Whipps Cross Hospital', 'NEL Trusts'))
