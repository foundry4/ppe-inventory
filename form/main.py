...
def get_sheet_data(site):
    ...
    #     'masks-iir-stock-levels': site['masks-iir-stock-levels'],
    #     'masks-iir-quantity_used': site['masks-iir-quantity_used'],
    #     'masks-iir-rag': site['masks-iir-rag'],
    #     'masks-ffp2-stock-levels': site['masks-ffp2-stock-levels'],
    #     'mask-ffp2-quantity_used': site['masks-ffp2-quantity_used'],
    #     'masks-ffp2-rag': site['masks-ffp2-rag'],
    #     'masks-ffp3-stock-levels': site['masks-ffp3-stock-levels'],
    #     'masks-ffp3-quantity_used': site['masks-ffp3-quantity_used'],
    #     'masks-ffp3-rag': site['masks-ffp3-rag'],
    #     'fit-test-solution-stock-levels': site['fit-test-solution-stock-levels'],
    #     'fit-test-solution-quantity_used': site['fit-test-solution-quantity_used'],
    #     'fit-test-solution-stock-levels-note': site['fit-test-solution-stock-levels-note'],
    #     'fit-test-solution-rag': site['fit-test-solution-rag'],
    #     'fit-test-fullkit-stock-levels': site['fit-test-fullkit-stock-levels'],
    #     'fit-test-fullkit-quantity_used': site['fit-test-fullkit-quantity_used'],
    #     'fit-test-fullkit-stock-levels-note': site['fit-test-fullkit-stock-levels-note'],
    #     'fit-test-fullkit-rag': site['fit-test-fullkit-rag'],
    #     'gloves-stock-levels': site['gloves-stock-levels'],
    #     'gloves-quantity_used': site['gloves-quantity_used'],
    #     'gloves-stock-levels-note': site['gloves-stock-levels-note'],
    #     'gloves-rag': site['gloves-rag'],
    #     'gowns-stock-levels': site['gowns-stock-levels'],
    #     'gowns-quantity_used': site['gowns-quantity_used'],
    #     'gowns-rag': site['gowns-rag'],
    #     'hand-hygiene-stock-levels': site['hand-hygiene-stock-levels'],
    #     'hand-hygiene-quantity_used': site['hand-hygiene-quantity_used'],
    #     'hand-hygiene-stock-levels-note': site['hand-hygiene-stock-levels-note'],
    #     'hand-hygiene-rag': site['hand-hygiene-rag'],
    #     'apron-stock-levels': site['apron-stock-levels'],
    #     'apron-quantity_used': site['apron-quantity_used'],
    #     'apron-rag': site['apron-rag'],
    #     'body-bags-stock-levels': site['body-bags-stock-levels'],
    #     'body-bags-quantity_used': site['body-bags-quantity_used'],
    #     'body-bags-rag': site['body-bags-rag'],
    #     'coveralls-stock-levels': site['coveralls-stock-levels'],
    #     'coveralls-quantity_used': site['coveralls-quantity_used'],
    #     'coveralls-rag': site['coveralls-rag'],
    #     'swabs-stock-levels': site['swabs-stock-levels'],
    #     'swabs-quantity_used': site['swabs-quantity_used'],
    #     'swabs-rag': site['swabs-rag'],
    #     'fit-test-solution-55ml-stock-levels': site['fit-test-solution-55ml-stock-levels'],
    #     'fit-test-solution-55ml-quantity_used': site['fit-test-solution-55ml-quantity_used'],
    #     'fit-test-solution-55ml-stock-levels-note': site['fit-test-solution-55ml-stock-levels-note'],
    #     'fit-test-solution-55ml-rag': site['fit-test-solution-55ml-rag'],
    #     'non-covid19-patient-number': site['non-covid19-patient-number'],
    #     'covid19-patient-number': site['covid19-patient-number'],
    #     'staff-number': site['staff-number'],
    #     'gowns-mutual_aid_received': site['gowns-mutual_aid_received'],
    #     'gowns-national_and_other_external_receipts': site['gowns-national_and_other_external_receipts'],
    #     'coveralls-mutual_aid_received': site['coveralls-mutual_aid_received'],
    #     'coveralls-national_and_other_external_receipts': site['coveralls-national_and_other_external_receipts']
    # })
